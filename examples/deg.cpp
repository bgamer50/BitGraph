...
int main(int argc, char* argv[]) {
    ...
    for(size_t r = 0; r < tries; ++r) {
        try {
            ...
            std::cout << string_any(h->V()->limit(1)->values("out_degree")->next()) << std::endl;
            ...
            std::cout << string_any(h->V()->limit(1)->values("in_degree")->next()) << std::endl;
            ...
            std::cout << string_any(h->V()->limit(1)->values("both_degree")->next()) << std::endl;
