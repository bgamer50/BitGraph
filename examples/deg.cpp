...
int main(int argc, char* argv[]) {
    ...
    for(size_t r = 0; r < tries; ++r) {
        try {
            ...
            std::cout << string_any(g->V()->has(NAME, "1000")->values("out_degree")->next());
            ...
            std::cout << string_any(g->V()->has(NAME, "1000")->values("in_degree")->next());
            ...
            std::cout << string_any(g->V()->has(NAME, "1000")->values("both_degree")->next());
