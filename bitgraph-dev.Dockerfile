...
RUN python3 -m pip install --extra-index-url https://pypi.nvidia.com cudf-cu12 torch scikit-learn cupy-cuda12x numpy pandas transformers torch_geometric gensim datasets sentencepiece protobuf "accelerate>=0.26.0" "nanobind>=2.2" "huggingface_hub[cli]"
